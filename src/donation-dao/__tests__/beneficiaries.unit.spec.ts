...
describe("Beneficiaries.get_donation_shares", () => {
    ...
    it("multiple owners with same shares get equal amount", () => {
        beneficiaries.apply_proposal(new AddBeneficiaryProposal(0, 0, owner, user1, 100, false));
    ...
    it("multiple owners with different shares get different amount", () => {
        beneficiaries.apply_proposal(new UpdateBeneficiaryProposal(0, 0, owner, owner, 75, true));
        beneficiaries.apply_proposal(new AddBeneficiaryProposal(0, 0, owner, user1, 25, false));
    ...
    it("uneven division first member gets more", () => {
        beneficiaries.apply_proposal(new AddBeneficiaryProposal(0, 0, owner, user1, 100, false));
        beneficiaries.apply_proposal(new AddBeneficiaryProposal(0, 0, owner, user2, 100, false));
